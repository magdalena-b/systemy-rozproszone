...
{
    default void sayHello(byte[] msg)
    {
        sayHello(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void sayHello(byte[] msg, java.util.Map<String, String> context)
    {
        _iceI_sayHelloAsync(msg, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sayHelloAsync(byte[] msg)
    {
        return _iceI_sayHelloAsync(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sayHelloAsync(byte[] msg, java.util.Map<String, String> context)
    {
        return _iceI_sayHelloAsync(msg, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_sayHelloAsync(byte[] iceP_msg, java.util.Map<String, String> context, boolean sync)
    {
